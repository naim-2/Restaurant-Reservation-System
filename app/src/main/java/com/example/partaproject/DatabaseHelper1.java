...
public class DatabaseHelper1 extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase DB) {
        DB.execSQL("Create Table Userdetails(username TEXT primary key, privilege TEXT, firstname TEXT, lastname TEXT, phonenumber TEXT, email TEXT, gender TEXT, password TEXT)");
    }
